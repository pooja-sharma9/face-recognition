...
class Student:
	...
	# This part is image labels setting start 
        ...
        f_lb1.place(x=0,y=0,width=1366,height=130)
		 ...
		 # backgorund image 
        bg1=Image.open("C:/face_recognition system/image_data/image3.jpg")
		...
		#title section
        title_lb1 = Label(bg_img,text="Welcome to Student Pannel",font=("verdana",30,"bold"),bg="darkgreen",fg="white")
        title_lb1.place(x=0,y=0,width=1366,height=45)
        
		# Creating Frame 
        main_frame = Frame(bg_img,bd=2,bg="white") #bd mean border 
        main_frame.place(x=3,y=53,width=1355,height=510)
        
		# Left Label Frame 
        left_frame = LabelFrame(main_frame,bd=2,bg="lightblue",relief=RIDGE,text="Student Details",font=("verdana",12,"bold"),fg="red")
        left_frame.place(x=10,y=10,width=660,height=480)
        
		# Current Course 
        current_course_frame = LabelFrame(left_frame,bd=2,bg="snow",relief=RIDGE,text="Current Course",font=("verdana",12,"bold"),fg="darkgreen")
        current_course_frame.place(x=10,y=5,width=635,height=150)

        #label Department
        dep_label=Label(current_course_frame,text="Department",font=("verdana",11,"bold"),bg="snow",fg="navyblue")
        dep_label.grid(row=0,column=0,padx=5,pady=15, sticky=W)
        
		#combo box 
        dep_combo=ttk.Combobox(current_course_frame,textvariable=self.var_dep,width=15,font=("verdana",11,"bold"),state="readonly")
        dep_combo["values"]=("Select Department","CSE","IT","Civil","Mechanical","EEE")
        dep_combo.current(0)
        ...
        #label Course
        cou_label=Label(current_course_frame,text="Course",font=("verdana",11,"bold"),bg="snow",fg="navyblue")
        cou_label.grid(row=0,column=2,padx=5,pady=15,sticky=W)
        
		#combo box 
        cou_combo=ttk.Combobox(current_course_frame,textvariable=self.var_course,width=15,font=("verdana",11,"bold"),state="readonly")
        cou_combo["values"]=("Select Course","Compiler Design","Wireless Communication","Cloud Computing","ML","AI","AI-ML","Big-Data")
        cou_combo.current(0)
		...
		#label Year
        year_label=Label(current_course_frame,text="Year",font=("verdana",11,"bold"),bg="snow",fg="navyblue")
        year_label.grid(row=1,column=0,padx=5,sticky=W)

        #combo box 
        year_combo=ttk.Combobox(current_course_frame,textvariable=self.var_year,width=15,font=("verdana",11,"bold"),state="readonly")
		...
		#label Semester 
        sem_label=Label(current_course_frame,text="Semester",font=("verdana",11,"bold"),bg="snow",fg="navyblue")
        sem_label.grid(row=1,column=2,padx=5,sticky=W)

        #combo box 
        sem_combo=ttk.Combobox(current_course_frame,textvariable=self.var_semester,width=15,font=("verdana",11,"bold"),state="readonly")
        ...
        #Student name
        student_name_label = Label(class_Student_frame,text="Std-Name:",font=("verdana",11,"bold"),fg="navyblue",bg="snow")
        student_name_label.grid(row=0,column=2,padx=5,pady=5,sticky=W)

        student_name_entry = ttk.Entry(class_Student_frame,textvariable=self.var_std_name,width=15,font=("verdana",11,"bold"))
        student_name_entry.grid(row=0,column=3,padx=2,pady=5,sticky=W)
        
		 #Class Division
        student_div_label = Label(class_Student_frame,text="Class Division:",font=("verdana",11,"bold"),fg="navyblue",bg="snow")
        student_div_label.grid(row=1,column=0,padx=5,pady=5,sticky=W)

        div_combo=ttk.Combobox(class_Student_frame,textvariable=self.var_div,width=13,font=("verdana",11,"bold"),state="readonly")
        ...
        student_roll_entry.grid(row=1,column=3,padx=2,pady=5,sticky=W)

        
		#Gender
        student_gender_label = Label(class_Student_frame,text="Gender:",font=("verdana",11,"bold"),fg="navyblue",bg="snow")
        student_gender_label.grid(row=2,column=0,padx=5,pady=5,sticky=W)

        #combo box 
        gender_combo=ttk.Combobox(class_Student_frame,textvariable=self.var_gender,width=13,font=("verdana",11,"bold"),state="readonly")
        gender_combo["values"]=("Male","Female","Others")
        gender_combo.current(0)
        gender_combo.grid(row=2,column=1,padx=5,pady=5,sticky=W)

        #Date of Birth
        student_dob_label = Label(class_Student_frame,text="DOB:",font=("verdana",11,"bold"),fg="navyblue",bg="snow")
        student_dob_label.grid(row=2,column=2,padx=5,pady=5,sticky=W)

        student_dob_entry = ttk.Entry(class_Student_frame,textvariable=self.var_dob,width=15,font=("verdana",11,"bold"))
        student_dob_entry.grid(row=2,column=3,padx=2,pady=5,sticky=W)

        #Email
        student_email_label = Label(class_Student_frame,text="Email:",font=("verdana",11,"bold"),fg="navyblue",bg="snow")
        student_email_label.grid(row=3,column=0,padx=5,pady=5,sticky=W)

        student_email_entry = ttk.Entry(class_Student_frame,textvariable=self.var_email,width=15,font=("verdana",11,"bold"))
        ...
        #Address
        student_address_label = Label(class_Student_frame,text="Address:",font=("verdana",11,"bold"),fg="navyblue",bg="snow")
        student_address_label.grid(row=4,column=0,padx=5,pady=5,sticky=W)

        student_address_entry = ttk.Entry(class_Student_frame,textvariable=self.var_address,width=15,font=("verdana",11,"bold"))
        student_address_entry.grid(row=4,column=1,padx=5,pady=5,sticky=W)

        #Teacher Name
        student_tutor_label = Label(class_Student_frame,text="Teacher Name:",font=("verdana",11,"bold"),fg="navyblue",bg="snow")
        student_tutor_label.grid(row=4,column=2,padx=5,pady=5,sticky=W)

        student_tutor_entry = ttk.Entry(class_Student_frame,textvariable=self.var_teacher,width=15,font=("verdana",11,"bold"))
        student_tutor_entry.grid(row=4,column=3,padx=2,pady=5,sticky=W)
		...
		#Button Frame
        btn_frame = Frame(left_frame,bd=2,bg="snow",relief=RIDGE)
        ...
        take_photo_btn.grid(row=0,column=4,padx=6,pady=10,sticky=W)
        
		#----------------------------------------------------------------------
        # Right Label Frame 
        right_frame = LabelFrame(main_frame,bd=2,bg="lightpink",relief=RIDGE,text="Student Details",font=("verdana",12,"bold"),fg="red")
        right_frame.place(x=680,y=10,width=660,height=480)

        #Searching System in Right Label Frame 
        search_frame = LabelFrame(right_frame,bd=2,bg="snow",relief=RIDGE,text="Search System",font=("verdana",12,"bold"),fg="darkgreen")
        search_frame.place(x=10,y=5,width=635,height=80)

        #Search
        search_label = Label(search_frame,text="Search By:",font=("verdana",11,"bold"),fg="navyblue",bg="snow")
        search_label.grid(row=0,column=0,padx=5,pady=5,sticky=W)
        self.var_searchTX=StringVar()
        #combo box 
        search_combo=ttk.Combobox(search_frame,textvariable=self.var_searchTX,width=12,font=("verdana",11,"bold"),state="readonly")
        search_combo["values"]=("Select","Roll-No")
        search_combo.current(0)
        search_combo.grid(row=0,column=1,padx=5,pady=15,sticky=W)

        self.var_search=StringVar()
        search_entry = ttk.Entry(search_frame,textvariable=self.var_search,width=12,font=("verdana",11,"bold"))
        search_entry.grid(row=0,column=2,padx=5,pady=5,sticky=W)

        search_btn=Button(search_frame,command=self.search_data,text="Search",width=9,font=("verdana",11,"bold"),fg="white",bg="navyblue")
        search_btn.grid(row=0,column=3,padx=5,pady=10,sticky=W)

        showAll_btn=Button(search_frame,command=self.fetch_data,text="Show All",width=8,font=("verdana",11,"bold"),fg="white",bg="navyblue")
        showAll_btn.grid(row=0,column=4,padx=5,pady=10,sticky=W)
        
		# -----------------------------Table Frame-------------------------------------------------
        #Table Frame 
        #Searching System in Right Label Frame 
        table_frame = Frame(right_frame,bd=2,bg="snow",relief=RIDGE)
        ...
        #create table 
        self.student_table = ttk.Treeview(table_frame,column=("ID","Roll-No","Name","Dep","Course","Year","Sem","Div","Gender","DOB","Mob-No","Address","Email","Teacher","Photo"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
...
# ==================================Generate Data set or take image=========================
    def generate_dataset(self):
        if self.var_dep.get()=="Select Department" or self.var_course.get=="Select Course" or self.var_year.get()=="Select Year" or self.var_semester.get()=="Select Semester" or self.var_std_id.get()=="" or self.var_std_name.get()=="" or self.var_div.get()=="" or self.var_roll.get()=="" or self.var_gender.get()=="" or self.var_dob.get()=="" or self.var_email.get()=="" or self.var_mob.get()=="" or self.var_address.get()=="" or self.var_teacher.get()=="":
            ...
            try:
                ...
                face_classifier = cv2.CascadeClassifier("C:/face_recognition system/haarcascade_frontalface_default.xml")
                ...
                while True:
                    ...
                    if face_croped(my_frame) is not None:
                        ...
                        file_path="C:/face_recognition system/data_img/student."+str(id)+"."+str(img_id)+".jpg"
